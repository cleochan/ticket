...
class WorkbookController extends Zend_Controller_Action
{
    ...
    {
		$this->view->title = "Workbook Management";
    ...
    function editAction()
    {
        ...
        $workbook_table = new KpiWorkbook();
        ...
        //redirect
		$this->_redirect('workbook/index/wb/'.$params['wb'].'/error/'.$error);
    }
